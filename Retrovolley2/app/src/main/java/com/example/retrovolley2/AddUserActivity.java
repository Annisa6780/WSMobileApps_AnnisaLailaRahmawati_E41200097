...
public class AddUserActivity extends AppCompatActivity {
    ...
    public void submitByRetrofit(User user){
        ...
        Retrofit.Builder builder= new Retrofit.Builder().baseUrl("https://192.168.43.85/volley/").addConverterFactory(GsonConverterFactory.create());
    ...
    public void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "https://192.168.43.85/volley/User_Registration.php";
